...
PS4["13.50"] = {
  fw_status:
    ...
    "kpatch=1350.bin-BUILT-10/10-neg-controls-pass-UNTESTED-on-hw payload=payload2.bin-PS4HEN(works<=13.50; 13.52=goldhen.bin) bug=663",
  ...
  payload: "payload2.bin", // PS4-HEN, works <=13.50; 13.52 uses goldhen.bin
};
...
PS4["13.52"] = Object.assign({}, PS4["13.50"], {
  ...
  payload: "goldhen.bin", // 13.52 only: GoldHEN; every other FW keeps payload2.bin (PS4-HEN)
  fw_status:
    ...
    "payload=goldhen.bin-GoldHEN-1352 (payload2.bin-PS4HEN retained for <=13.50; " +
    "patched-GoldHEN KP'd 2/2) " +
    "bug=663",
});
...
PS4["13.02"] = Object.assign({}, PS4["13.00"], {
  ...
  payload: "payload2.bin", // PS4-HEN, works <=13.50; 13.52 uses goldhen.bin; replaces the non-shipped 13.00 placeholder
  fw_status:
    ...
    "kpatch=1302.bin-HW-PROVEN-KEXEC-rc0 payload=payload2.bin-PS4HEN(works<=13.50; 13.52=goldhen.bin) bug=663",
});
...
PS4["13.04"] = Object.assign({}, PS4["13.00"], {
  ...
  fw_status:
    ...
    "kpatch=1302.bin-shared-HW-PROVEN payload=payload2.bin-PS4HEN(works<=13.50; 13.52=goldhen.bin) bug=663",
});
